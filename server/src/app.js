...
module.exports = function () {
  ...
  app.use(morgan('Incoming IP :xRealIp - Forward For IP :xForwardFor - :remote-user [:date[clf]] ":method :url HTTP/:http-version" :status :res[content-length] ":referrer" ":user-agent"', {'stream': logger.stream}));
